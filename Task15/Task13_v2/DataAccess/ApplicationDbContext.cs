...
namespace Task13.DataAccess
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<ApplicationOtp> otps { get; set; }
        ...
        public DbSet<Task13_v2.ViewModels.VerifyOtpVM> VerifyOtpVM { get; set; } = default!;
        public DbSet<Task13_v2.ViewModels.ResetPaswordVM> ResetPaswordVM { get; set; } = default!;
        //public DbSet<Task13_v2.ViewModels.ForgotPaswordVM> ForgotPaswordVM { get; set; } = default!;
        //public DbSet<Task13_v2.ViewModels.RegisterVM> RegisterVM { get; set; } = default!;
        //public DbSet<Task13_v2.ViewModels.LoginVM> LoginVM { get; set; } = default!;
    }
}
